...
public class ParquetAvroHandler
{
    ...
    private static final String SCHEMA_PATH = "src/main/resources/schema.avsc";
    private static final Path OUTPUT_PATH = new Path("src/main/resources/customer.parquet");
